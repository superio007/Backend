...
export interface ApiBrandTagLineBrandTagLine
  extends Struct.CollectionTypeSchema {
  collectionName: 'brand_tag_lines';
  info: {
    displayName: 'Brand Tag Line';
    pluralName: 'brand-tag-lines';
    singularName: 'brand-tag-line';
  };
  options: {
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    brandslogos: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCaseStudiesCardCaseStudiesCard
  extends Struct.CollectionTypeSchema {
  collectionName: 'case_studies_cards';
  info: {
    displayName: 'Case Studies Cards';
    pluralName: 'case-studies-cards';
    singularName: 'case-studies-card';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiCustomerExperienceCustomerExperience
  ...
  info: {
    ...
    pluralName: 'customer-experiences';
    singularName: 'customer-experience';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiHomepageContentHomepageContent
  ...
  attributes: {
    ...
    >;
    skills_cards: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiShopifySolutionShopifySolution
  extends Struct.CollectionTypeSchema {
  collectionName: 'shopify_solutions';
  info: {
    displayName: 'Shopify Solutions';
    pluralName: 'shopify-solutions';
    singularName: 'shopify-solution';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    mockups: Schema.Attribute.Media<'images', true>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
...
export interface ApiSkillsCardSkillsCard extends Struct.CollectionTypeSchema {
  collectionName: 'skills_cards';
  info: {
    description: '';
    displayName: 'Skills Cards';
    pluralName: 'skills-cards';
    singularName: 'skills-card';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::brand-tag-line.brand-tag-line': ApiBrandTagLineBrandTagLine;
